...
contract DeployDeterministicProxyPlugin is BaseScript {
    ...
    function run(ISablierV2ChainLog chainLog) public virtual broadcaster returns (SablierV2ProxyPlugin plugin) {
        plugin = new SablierV2ProxyPlugin{ salt: ZERO_SALT }(chainLog);
    }
}
