...
interface IBlastGovernor {
    ...
    /// @notice Claim all yield in an ERC20 token for `account` when Claimable configuration is used.
    ...
    /// @notice Claim all gas in ETH for `account` when Claimable configuration is used.
    /// @dev Only callable by the admin.
    /// @param blastEthAddress The address of the Blast ETH contract.
    ...
    /// @notice Claim all yield in ETH for `account` when Claimable configuration is used.
    /// @dev Only callable by the admin.
    /// @param blastEthAddress The address of the Blast ETH contract.
    /// @param recipientOfYield The recipient address for yield.
