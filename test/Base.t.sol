...
abstract contract Base_Test is DeployOptimized, Events, Merkle, V2CoreAssertions, V2CoreUtils {
    ...
    function computeMerkleStreamerLLAddress(
        ...
        returns (address)
    {
        return computeMerkleStreamerLLAddress(admin, dai, merkleRoot, expiration);
    }
        ...
        returns (address)
    {
        ...
        bytes32 creationBytecodeHash = keccak256(getMerkleStreamerLLBytecode(admin, asset_, merkleRoot, expiration));
