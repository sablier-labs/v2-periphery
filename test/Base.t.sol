...
import { ISablierV2BatchCreate } from "src/interfaces/ISablierV2BatchCreate.sol";
...
import { SablierV2BatchCreate } from "src/SablierV2BatchCreate.sol";
...
abstract contract Base_Test is Assertions, Events, Merkle, StdCheats, V2CoreUtils {
    ...
    ISablierV2BatchCreate internal batchCreate;
    ...
    function deployPeripheryConditionally() internal {
        if (!isTestOptimizedProfile()) {
            ...
            batchCreate = new SablierV2BatchCreate();
            ...
            batchCreate = deployPrecompiledBatchCreate();
    ...
    /// @dev Deploys {SablierV2BatchCreate} from a source precompiled with `--via-ir`.
    function deployPrecompiledBatchCreate() internal returns (ISablierV2BatchCreate) {
        return ISablierV2BatchCreate(deployCode("out-optimized/SablierV2BatchCreate.sol/SablierV2BatchCreate.json"));
    }
