...
import { IYield, YieldMode } from "@sablier/v2-core/src/interfaces/Blast/IYield.sol";
...
abstract contract ERC20Rebasing is IERC20 {
    ...
    /// @inheritdoc IERC20
    function balanceOf(address account) public view virtual returns (uint256 value) {
    ...
    function _computeSharesAndRemainder(
        uint256 currentSharePrice,
        uint256 value
    )
        internal
        pure
        returns (uint256 shares, uint256 remainder)
    {
