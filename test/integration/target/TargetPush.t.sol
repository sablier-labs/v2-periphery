...
contract BatchCancelMultiple_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    BatchCancelMultiple_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, BatchCancelMultiple_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        BatchCancelMultiple_Integration_Test.setUp();
    }
}

contract BatchCreateWithDeltas_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    BatchCreateWithDeltas_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, BatchCreateWithDeltas_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        BatchCreateWithDeltas_Integration_Test.setUp();
    }
}

contract BatchCreateWithDurations_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    BatchCreateWithDurations_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, BatchCreateWithDurations_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        BatchCreateWithDurations_Integration_Test.setUp();
    }
}

contract BatchCreateWithMilestones_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    BatchCreateWithMilestones_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, BatchCreateWithMilestones_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        BatchCreateWithMilestones_Integration_Test.setUp();
    }
}

contract BatchCreateWithRange_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    BatchCreateWithRange_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, BatchCreateWithRange_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        BatchCreateWithRange_Integration_Test.setUp();
    }
}

contract Burn_TargetPush_Integration_Test is TargetPush_Integration_Test, Burn_Integration_Test {
    function setUp() public virtual override(TargetPush_Integration_Test, Burn_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        Burn_Integration_Test.setUp();
    }
}

contract Cancel_TargetPush_Integration_Test is TargetPush_Integration_Test, Cancel_Integration_Test {
    function setUp() public virtual override(TargetPush_Integration_Test, Cancel_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        Cancel_Integration_Test.setUp();
    }
}

contract CancelAndCreate_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    CancelAndCreate_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, CancelAndCreate_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        CancelAndCreate_Integration_Test.setUp();
    }
}

contract CancelMultiple_TargetPush_Integration_Test is TargetPush_Integration_Test, CancelMultiple_Integration_Test {
    function setUp() public virtual override(TargetPush_Integration_Test, CancelMultiple_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        CancelMultiple_Integration_Test.setUp();
    }
}

contract Renounce_TargetPush_Integration_Test is TargetPush_Integration_Test, Renounce_Integration_Test {
    function setUp() public virtual override(TargetPush_Integration_Test, Renounce_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        Renounce_Integration_Test.setUp();
    }
}

contract Withdraw_TargetPush_Integration_Test is TargetPush_Integration_Test, Withdraw_Integration_Test {
    function setUp() public virtual override(TargetPush_Integration_Test, Withdraw_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        Withdraw_Integration_Test.setUp();
    }
}

contract WithdrawMax_TargetPush_Integration_Test is TargetPush_Integration_Test, WithdrawMax_Integration_Test {
    function setUp() public virtual override(TargetPush_Integration_Test, WithdrawMax_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        WithdrawMax_Integration_Test.setUp();
    }
}

contract WithdrawMaxAndTransfer_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    WithdrawMaxAndTransfer_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, WithdrawMaxAndTransfer_Integration_Test) {
        TargetPush_Integration_Test.setUp();
        WithdrawMaxAndTransfer_Integration_Test.setUp();
    }
}

contract WithdrawMultiple_TargetPush_Integration_Test is
    TargetPush_Integration_Test,
    WithdrawMultiple_Integration_Test
{
    function setUp() public virtual override(TargetPush_Integration_Test, WithdrawMultiple_Integration_Test) {
        TargetPush_Integration_Test.setUp();
